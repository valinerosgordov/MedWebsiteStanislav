      ...
      <section className="page-header">
        <div className="container">
          ...
          <p className="page-header__subtitle">
            Актуальные новости о деятельности Федерации и событиях в отрасли превентивной медицины
          </p>
        </div>
      </section>
