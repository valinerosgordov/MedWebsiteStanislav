...
const partnerTypes = [
  {
    ...
    desc: 'Объединения врачей, нутрициологов, диетологов и других специалистов превентивной медицины',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    desc: 'Клиники, центры оздоровления, производители БАДов, wellness-центры и фитнес-клубы',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
