...
const directions = [
  'Развитие превентивной медицины, нутрициологии и здорового образа жизни',
    ...
    <div className="page-about">
      ...
      <section className="page-header">
        <div className="container">
          ...
          <h1 className="page-header__title">Федерация специалистов превентивной медицины и питания</h1>
          <p className="page-header__subtitle">
            Профессиональное объединение специалистов и организаций в сфере превентивной медицины,
          ...
          <div className="split-section">
            <div className="split-section__content">
              ...
              <p className="text-lg">
                ...
                превентивной медицины, оздоровления и здорового образа жизни. Мы формируем
                экспертное сообщество, развиваем стандарты качества и объединяем науку, практику и бизнес.
              </p>
              <p className="text-body">
                Автономная некоммерческая организация &laquo;Федерация специалистов превентивной
                медицины и питания&raquo; (ИНН: 9728169432) была создана с целью объединения
                профессионального сообщества и формирования ответственной, научно-обоснованной
                культуры превентивного здоровья в России.
              </p>
            </div>
        ...
        <div className="container">
          <div className="cta-block">
            ...
            <p className="text-lg text--white-muted">
              Станьте частью профессиональной экосистемы превентивной медицины и здорового образа жизни
            </p>
