...
const goals = [
  {
    ...
    desc: 'Развитие превентивной медицины, нутрициологии и здорового образа жизни',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    desc: 'Содействие формированию профессиональных стандартов и этики специалистов в области превентивной медицины и нутрициологии',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    desc: 'Формирование стандартов образовательных программ для специалистов в области превентивной медицины и нутрициологии',
  },
];
      ...
      <section className="page-header">
        <div className="container">
          ...
          <p className="page-header__subtitle">
            Федерация ведёт системную работу по развитию отрасли превентивной медицины и здорового образа жизни в России
          </p>
        </div>
      </section>
          ...
          <div className="legal-basis">
            ...
            <div className="legal-basis__content">
              ...
              <p className="text-lg">
                ...
                Федерации на период до 2030 года, определяющем приоритеты в сфере превентивной
                медицины, профилактики заболеваний и здорового образа жизни.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="cta-block">
            ...
            <p className="text-lg text--white-muted">
              Присоединяйтесь к Федерации и внесите свой вклад в развитие отрасли превентивной медицины и здорового образа жизни в России.
            </p>
